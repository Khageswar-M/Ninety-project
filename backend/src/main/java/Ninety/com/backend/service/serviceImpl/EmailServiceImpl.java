...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    @Async
    public CompletableFuture<Void> sendOtpEmail(SendOtpEmailRequest request) {

        String otp = otpService.generateAndStoreOtp(request.getToEmail());
        ...
        return send(request.getToEmail(), "Your Ninety verification code", html);
    }
